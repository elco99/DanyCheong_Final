...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_eliminar_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 34, 21)
    ...
    "eliminar\0on_pushButton_2_clicked\0\0"
...
const QMetaObject eliminar::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_eliminar.data,
      qt_meta_data_eliminar,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_eliminar.stringdata))
