...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_transport_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 81, 23)
    ...
    "transport\0on_pushButton_clicked\0\0"
...
void transport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        transport *_t = static_cast<transport *>(_o);
        switch (_id) {
...
const QMetaObject transport::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_transport.data,
      qt_meta_data_transport,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_transport.stringdata))
        return static_cast<void*>(const_cast< transport*>(this));
