...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_trip_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 104, 21)
    },
    "trip\0on_v_pasajero_valueChanged\0\0arg1\0"
    "on_v_transporte_currentIndexChanged\0"
...
void trip::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_v_pasajero_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_v_transporte_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
...
const QMetaObject trip::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_trip.data,
      qt_meta_data_trip,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_trip.stringdata))
        return static_cast<void*>(const_cast< trip*>(this));
